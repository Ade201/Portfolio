...
document.getElementById("contactForm").addEventListener("submit", function (e) {
  ...
  fetch(
    "https://script.google.com/macros/s/AKfycbzROdkOffC10GwhOkEcVKaIomlRFGqZgCJnXvvakVOQvaxZJzWLljxNvRTRYYvxFz0afw/exec",
    {
      // Replace with your Web App URL
      method: "POST",
      mode: "no-cors", // keeps it simple for public form
